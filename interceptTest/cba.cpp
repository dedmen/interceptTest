...
void cba::preStart() {
    ...
    static auto _execIn = intercept::client::host::registerFunction("execIn"sv, "Executes code after x seconds"sv, [](uintptr_t, game_value_parameter left, game_value_parameter right) -> game_value {
    ...
    auto codeType = client::host::registerType(r_string("Bugger off would you?"), r_string("Bugger off would you?"), r_string("Bugger off would you?r"), r_string("Bugger off would you?"), createGameDataCrap);
    GameDataCrap_type = codeType.second;

    static auto _CrapFunc = intercept::client::host::registerFunction("doStuff"sv, ""sv, [](uintptr_t, game_value_parameter right) -> game_value {
        return  {};
    }, GameDataType::NOTHING, codeType.first);
